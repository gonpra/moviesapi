...
public interface IMovieService
{
    ...
    /// <param name="pageable">A Pageable object containing pagination information.</param>
    ...
    Task<Movie?> Update(Guid id, Movie updatedMovie);

    /// <summary>
    /// Deletes the movie with the specified ID.
    /// </summary>
    /// <param name="id">The ID of the movie to delete.</param>
    /// <returns>The deleted movie, or null if the movie does not exist.</returns>
